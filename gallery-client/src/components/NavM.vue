<template>
    <div class="visibility">
        ...
        <div ref="navClick" class="navigation-click-container">
            <button class="cross" @click="navCLose"><svg width="39" height="39" viewBox="0 0 39 39" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M19.5 24.2625L34.2375 39L39 34.2375L24.2625 19.5L39 4.76253L34.2375 0L19.5 14.7375L4.76253 0L0 4.76253L14.7375 19.5L1.33817e-06 34.2375L4.76253 39L19.5 24.2625Z"/></svg></button>
            <div class="navigation-click">
                <div class="closer" ref="closer"></div>
...
<style scoped>
    ...
    .navigation-click {
        background-image: url(../assets/about/menu-bg.jpg);
        width: 100%;
        display: flex;
